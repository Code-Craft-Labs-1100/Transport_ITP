        ...
        <div className="container flex justify-between items-start mr-20 mb-5">
          ...
          <div className="w-[500px] max-w-2xl bg-white shadow-xl rounded-3xl p-6 mt-20">
            ...
            >
              ...
              <option value="type_A">HDPE</option>
              <option value="type_B">PVC</option>
              <option value="type_C">Polypropylene</option>
              <option value="type_D">Polystyrene</option>
              <option value="type_E">Acrylic</option>
            </select>
              </div>
